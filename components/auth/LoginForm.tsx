...
export const LoginForm: React.FC<LoginFormProps> = ({ onLoginSuccess, onSwitchToSignup, onNeedVerification }) => {
    ...
    return (
        <div className="w-full max-w-md bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl p-8 shadow-2xl animate-fade-in relative z-10">
            <div className="flex flex-col items-center mb-8">
                ...
                <p className="text-white/40 text-sm mt-2">Login to Zara AI Assist</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                    type="submit"
                    disabled={isLoading}
                    className="w-full bg-white text-black font-bold py-4 rounded-xl hover:bg-white/90 focus:scale-[0.98] transition-all flex items-center justify-center gap-2 group disabled:opacity-70 disabled:cursor-not-allowed mt-4"
                >
            ...
            <div className="mt-6 text-center">
                <p className="text-white/40 text-sm">
                    ...
                    <button onClick={onSwitchToSignup} className="text-purple-400 hover:text-purple-300 font-bold transition-colors">
                        Sign Up
                    </button>
                </p>
            </div>
